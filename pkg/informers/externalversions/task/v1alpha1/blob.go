...
import (
	...
	apistaskv1alpha1 "github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1"
	versioned "github.com/OpenCIDN/apis/pkg/clientset/versioned"
	internalinterfaces "github.com/OpenCIDN/apis/pkg/informers/externalversions/internalinterfaces"
	taskv1alpha1 "github.com/OpenCIDN/apis/pkg/listers/task/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TaskV1alpha1().Blobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TaskV1alpha1().Blobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TaskV1alpha1().Blobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TaskV1alpha1().Blobs(namespace).Watch(ctx, options)
			},
		},
		&apistaskv1alpha1.Blob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *blobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apistaskv1alpha1.Blob{}, f.defaultInformer)
}

func (f *blobInformer) Lister() taskv1alpha1.BlobLister {
	return taskv1alpha1.NewBlobLister(f.Informer().GetIndexer())
}
