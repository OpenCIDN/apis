...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Blob":             schema_pkg_apis_task_v1alpha1_Blob(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobList":         schema_pkg_apis_task_v1alpha1_BlobList(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobSpec":         schema_pkg_apis_task_v1alpha1_BlobSpec(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobStatus":       schema_pkg_apis_task_v1alpha1_BlobStatus(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Condition":        schema_pkg_apis_task_v1alpha1_Condition(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Sync":             schema_pkg_apis_task_v1alpha1_Sync(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTP":         schema_pkg_apis_task_v1alpha1_SyncHTTP(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTPRequest":  schema_pkg_apis_task_v1alpha1_SyncHTTPRequest(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTPResponse": schema_pkg_apis_task_v1alpha1_SyncHTTPResponse(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncList":         schema_pkg_apis_task_v1alpha1_SyncList(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncSpec":         schema_pkg_apis_task_v1alpha1_SyncSpec(ref),
		"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncStatus":       schema_pkg_apis_task_v1alpha1_SyncStatus(ref),
...
func schema_pkg_apis_task_v1alpha1_Blob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Blob is an API that describes the staged change of a resource",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status holds status for the Blob",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobSpec", "github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.BlobStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_task_v1alpha1_BlobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BlobList contains a list of Blob",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Blob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Blob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"destination": {
						SchemaProps: spec.SchemaProps{
							Description: "Destination is the destination of the blob.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
				...
				Required: []string{"handlerName", "source", "destination", "weight", "total", "hash"},
			},
		},
	}
}

func schema_pkg_apis_task_v1alpha1_BlobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions holds conditions for the Blob.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Condition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Condition"},
	}
}
...
func schema_pkg_apis_task_v1alpha1_Sync(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec holds information about the request being evaluated.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncSpec", "github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_task_v1alpha1_SyncHTTP(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"request": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTPRequest"),
						},
					},
					"response": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTPResponse"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTPRequest", "github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTPResponse"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"method": {
						SchemaProps: spec.SchemaProps{
							Description: "Method is the HTTP method (GET, POST, PUT, DELETE, etc)",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"url": {
						SchemaProps: spec.SchemaProps{
							Description: "URL is the target URL for the request",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"statusCode": {
						SchemaProps: spec.SchemaProps{
							Description: "StatusCode is the expected HTTP status code",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
...
func schema_pkg_apis_task_v1alpha1_SyncList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Sync"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.Sync", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_task_v1alpha1_SyncSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"source": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTP"),
						},
					},
					"destination": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/OpenCIDN/apis/pkg/apis/task/v1alpha1.SyncHTTP"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"retry": {
						SchemaProps: spec.SchemaProps{
							Description: "Retry is the number of times the sync has been retried.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"hashSnapshot": {
						SchemaProps: spec.SchemaProps{
							Description: "HashSnapshot contains the hash of the resource snapshot being verified.",
							Type:        []string{"string"},
							Format:      "byte",
						},
					},
